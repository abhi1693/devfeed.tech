...
Upload `apps/extensions/dist/devfeed-edge-extension-0.1.8.zip` to Microsoft Partner
...
`apps/extensions/dist/devfeed-chrome-extension-0.1.8.zip` with the manifest at the ZIP root.
