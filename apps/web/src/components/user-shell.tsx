    ...
    <>
      ...
      <header className="topbar">
        ...
        <div className="header-actions">
          <a className="navbar-icon" href="https://github.com/abhi1693/devfeed.tech" target="_blank" rel="noopener noreferrer" aria-label="DevFeed on GitHub (opens in a new tab)" title="DevFeed on GitHub">
