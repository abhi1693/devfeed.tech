...
it("replaces article images that failed before hydration", () => {
  ...
  const view = render(
    <ArticleImage src="https://example.test/missing.png" label="Docker" />,
  );
...
it("replaces catalog logos that failed before hydration", () => {
  ...
  const view = render(
    <CatalogIcon url="https://example.test/missing.png" source />,
  );
  expect(view.container.querySelector("img")).toBeNull();
...
it("keeps loaded images and falls back on later failures", () => {
  ...
  const view = render(
    <ArticleImage src="https://example.test/cover.png" label="Docker" />,
  );
  expect(view.container.querySelector("img")).toBeTruthy();
  fireEvent.error(view.container.querySelector("img")!);
  expect(view.getByText("Docker")).toBeTruthy();
  view.rerender(
    <ArticleImage src="https://example.test/new-cover.png" label="Docker" />,
  );
