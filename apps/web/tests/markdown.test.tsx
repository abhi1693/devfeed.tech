...
it("keeps catalog summaries free of nested links", () => {
  ...
  expect(screen.queryByRole("link")).toBeNull();expect(screen.getByText("readable")).toBeTruthy();
});
