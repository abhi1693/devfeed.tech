        ...
        {settingsSections.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex shrink-0 items-center gap-2 border-b-2 border-transparent px-2 py-2.5 text-xs text-muted-foreground hover:bg-muted/50 hover:text-foreground sm:px-4 sm:text-sm",
                active === item.id && "border-primary font-medium text-foreground",
              )}
            >
