...
export function PageHeading({ title, description, trail = [], leading, children }: { title: string; description?: string; trail?: { label: string; href: string }[]; leading?: React.ReactNode; children?: React.ReactNode }) {
