...
import { useEffect, useId, useRef, useState, type AriaAttributes, type ReactNode } from "react";
  ...
  return <div className={cn("relative min-w-0", className)}>
    ...
    <Popover open={open && !disabled} onOpenChange={changeOpen}>
      <PopoverTrigger asChild><Button ref={trigger} id={triggerId} type="button" variant="outline" role="combobox"
        ...
        disabled={disabled} size={size} className="w-full justify-between gap-2 border-input px-3 text-base font-normal shadow-xs md:text-sm"
