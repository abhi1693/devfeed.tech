...
export function AdminLayout({ admin, settings, children }: { admin: AdminIdentity; settings?: UserSettings; children: React.ReactNode }) {
  return <AdminSession admin={admin} settings={settings}><div className="min-h-dvh">
