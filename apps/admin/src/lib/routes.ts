...
export type DetailSection = UserSection | "analysis" | "details" | "related" | "history" | "evidence" | "logs";
...
export function detailSections(resource: Resource): DetailSection[] {
  if (resource === "users") return ["details", "analysis", "topics", "sources", "likes", "interests", "recommendations"];
