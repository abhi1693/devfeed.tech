...
export const resources: Record<Resource, ResourceSpec> = {
  ...
  topics: { label: "Topics", singular: "Topic", description: "The single catalog of developer subjects. Import or discover proposals, then review them before activation.", group: "Taxonomy", title: "name", defaultSort: "name", columns: [identityColumns[0], { key: "kind", label: "Kind", sort: true }, { key: "status", label: "Status", sort: true }, { key: "updated_at", label: "Updated", date: true }], filter: { key: "status", label: "Status", choices: ["proposed", "active", "rejected"] }, fields: [name, slug, { key: "kind", label: "Kind", required: true, max: 50, help: "A descriptive kind, such as discipline, language, framework, or platform." }, { key: "status", label: "Status", type: "select", choices: ["proposed", "active", "rejected"], required: true, default: "active" }, { ...aliases, help: "One alternative name or abbreviation per line. Shared aliases are allowed and help find all matching topics." }, { key: "keywords", label: "Matching keywords", type: "lines", help: "Reviewed terms used by fallback classification. Aliases help search and AI candidate selection." }, { key: "description", label: "Description", type: "textarea", max: 2000, help: "Write a short description in plain text." }, { key: "website_url", label: "Website", type: "url", max: 2048 }, { key: "logo_url", label: "Logo URL", type: "logo-url", max: 2048 }] },
  tags: { label: "Tags", singular: "Tag", description: "Labels automatically linked to matching topics, with manual overrides.", group: "Taxonomy", title: "name", defaultSort: "name", columns: [...identityColumns, { key: "topic_id", label: "Topic", resource: "topics" }, { key: "topic_match_status", label: "Topic discovery" }], fields: [name, slug, aliases, { key: "auto_link_topic", label: "Discover topic automatically", type: "boolean", default: true, help: "Match names, slugs, and aliases against active topics in the background. Shared names stay unlinked. Turn off to choose or clear the topic manually." }, topic] },
  "topic-relations": { label: "Topic relationships", singular: "Topic relationship", description: "Approved relationships and AI suggestions awaiting review.", group: "Taxonomy", title: "relation", defaultSort: "relation", columns: [{ key: "topic_id", label: "From topic", resource: "topics" }, { key: "relation", label: "Relationship", sort: true }, { key: "related_topic_id", label: "To topic", resource: "topics" }, { key: "status", label: "Status", sort: true }, { key: "evidence_url", label: "Evidence" }], filter: { key: "status", label: "Status", choices: ["pending", "approved"] }, fields: [{ key: "topic_id", label: "From topic", type: "reference", resource: "topics", required: true, createOnly: true }, { key: "relation", label: "Relationship", type: "select", choices: relationKinds, required: true, createOnly: true, default: "related_to" }, { key: "related_topic_id", label: "To topic", type: "reference", resource: "topics", required: true, createOnly: true }, { key: "evidence_url", label: "Evidence URL", type: "url", max: 2048 }] },
