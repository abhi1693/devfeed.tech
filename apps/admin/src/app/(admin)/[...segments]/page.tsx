...
export default async function AdminRoutePage({
  ...
  switch (route.view) {
    case "group":
      return <ResourceGroup group={route.group} />;
    case "list":
      return <ResourceList key={key} resource={route.resource} analysisType={route.analysisType} />;
    case "new":
      return <ResourceForm key={key} resource={route.resource} />;
    case "edit":
      return <ResourceForm key={key} resource={route.resource} id={route.id} />;
    case "delete":
      return <ResourceDelete key={key} resource={route.resource} id={route.id} />;
    case "detail":
      return (
        <ResourceDetail key={key} resource={route.resource} id={route.id} section={route.section} />
      );
    case "workflow":
      return (
    ...
    case "import":
      return <TopicImport />;
    case "proposal":
      return <TopicProposalReview key={key} id={route.id} />;
    case "relationship-discover":
      return <RelationshipDiscovery key={key} />;
    case "relationship-proposals":
      return <RelationshipProposals />;
    case "relationship-proposal":
      return <RelationshipProposalReview key={key} id={route.id} />;
    case "enrich":
      return <TopicEnrichment key={key} id={route.id} />;
  }
}
