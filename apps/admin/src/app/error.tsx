...
export default function ErrorPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      notify.error("Could not load this page", {
        description: "Check the service connection and try again.",
        id: "page-error",
      });
    }, 0);
  ...
  return (
    <main className="mx-auto max-w-lg space-y-4 px-5 py-20">
      <PageTitle title="Admin service unavailable" />
      <h1 className="text-xl font-semibold">Admin service unavailable</h1>
      <p className="text-sm text-muted-foreground">
        Could not load this page. Check the service connection and try again.
      </p>
