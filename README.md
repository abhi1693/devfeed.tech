...
**DevFeed is in early development.** The feed and editorial tools are working;
the reader website and browser extensions are still ahead. Follow along and help
...
- **Choose what interests you.** Explore topics, search for something specific,
  ...
  news. Leave out tags and sources you don't want to see.
...
- **Read without an account.** Discovery is designed around your interests,
  with no reader registration required.

These capabilities are supported by the feed today. The website will make them
available in an everyday browsing experience; the planned browser extensions
will bring discovery to your new tab.
